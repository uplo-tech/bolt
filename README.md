...
```sh
$ go get github.com/uplo-tech/bolt/...
```
...
```go
import bolt "github.com/uplo-tech/bolt"
...
import (
	...
	bolt "github.com/uplo-tech/bolt"
)
...
system's page cache. See the [`Tx`](https://godoc.org/github.com/uplo-tech/bolt#Tx)
